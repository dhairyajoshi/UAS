...
class Program(models.Model):
    ...
    departments = models.ForeignKey(to= 'core.Department',on_delete=models.CASCADE,related_name="program_department",null=True)
...
class Course(models.Model):
    ...
    dept = models.ForeignKey(to='core.Department',related_name='course_department',on_delete=models.CASCADE,null = True)
    def __str__(self):
...
class SemesterCourse(models.Model):
    ...
    faculty =models.ForeignKey(Faculty,related_name='semcourse_fcltydetails',on_delete=models.CASCADE,null = True)
...
class Examination(models.Model):
    ...
    dept = models.ForeignKey(Department,related_name= 'Exam_deptdetail',on_delete=models.CASCADE,null= True)
...
class SemesterMarks(models.Model):
    ...
    fclt = models.ForeignKey(Faculty,related_name='semmarks_fcltydetails',on_delete=models.CASCADE,null = True)
    dept = models.ManyToManyField(Department,related_name="semmarks_deptdetails")
